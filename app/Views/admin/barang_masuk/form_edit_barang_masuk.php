              ...
              <div class="row">
                <div class="col-md-8">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control <?= validation_show_error('garansi') ? 'is-invalid' : '' ?>" id="garansi" name="garansi" placeholder="Garansi" value="<?= old('garansi', $produk['garansi']) ?>" disabled>
                    <div class="invalid-feedback">
