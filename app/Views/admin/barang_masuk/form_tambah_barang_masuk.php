                ...
                <div class="row">
                  <div class="col-md-8">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control <?= validation_show_error('nama_pemasok') ? 'is-invalid' : '' ?>" id="inputNamaPemasok" name="nama_pemasok" placeholder="Nama Pemasok" value="<?= old('nama_pemasok') ?>">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="number" class="form-control <?= validation_show_error('harga_beli') ? 'is-invalid' : '' ?>" id="inputHargaBeli" min="0" name="harga_beli" placeholder="Harga Beli" value="<?= old('harga_beli') ?>">
                          <div class="invalid-feedback">
                      ...
                      <div class="col-md-6">
                        <div class="mb-3">
                          ...
                          <input type="number" class="form-control <?= validation_show_error('jumlah_beli') ? 'is-invalid' : '' ?>" id="inputJumlahBeli" min="0" name="jumlah_beli" placeholder="Jumlah Beli" value="<?= old('jumlah_beli') ?>">
                          <div class="invalid-feedback">
